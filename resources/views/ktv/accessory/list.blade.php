...
<div class="form-popup" id="myForm">
    <form action="{{route('device.accessory','id')}}" class="form-container form" method="post">
      ...
      <table>
        ...
        <tr>
          <td colspan="2">
            <select type="text" name="dv_id" style="height: 50px;" class="form-control" required>
    ...
    <form action="{{route('accessory.plus',['id','user_id'=>Auth::id()])}}" class="form-container form1" method="post">
      ...
      <table>
        ...
        <tr>
          ...
          <input type="datetime-local"  name="import_date" style="width: 300px;height: 40px;border-radius: 5px;" required></div></td>
        </tr>
        <tr>
