       ...
       <td></td>
        <td colspan="3">
          <div style="float: right;" class="rgt1">
              <a class="rgt" style="margin-right: 20px;text-decoration: none;font-weight: bold;font-size: 20px;color: black;" href="{{ route('device.maintainCheck',['id'=>$dev->dv_id]) }}">Lịch sử bảo dưỡng</a>
          </div>
          <div>
