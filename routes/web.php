...
Route::get('/','HomeController@index')->name('get.login');
...
Route::group(['prefix'=>'ktv'],function(){
		//ktv
		...
		Route::get('device/view/','UserController@viewDevice')->name('device.view');
	...
	Route::group(['prefix'=>'doctor'],function(){
		...
		Route::get('print/device/{id}','DoctorController@print_device')->name('doctor.print.device');
	});
